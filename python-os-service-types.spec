...
%else
%global excluded_brs doc8 bandit pre-commit hacking flake8-import-order oslotest keystoneauth1
%endif
...
sed -i 's|python setup.py build_sphinx|sphinx-build -W -b html -d doc/build/doctrees doc/source doc/build/html|' tox.ini
...
%{python3_sitelib}/%{module_name}-%{upstream_version}.dist-info
...
%changelog
# REMOVEME: error caused by commit https://opendev.org/openstack/os-service-types/commit/dbbc06795ce655011dc055f29587bf90f2de03f4
